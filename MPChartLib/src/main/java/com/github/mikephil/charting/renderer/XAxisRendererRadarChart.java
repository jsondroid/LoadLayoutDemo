...
//            drawLabel(c, label, pOut.x, pOut.y - mXAxis.mLabelRotatedHeight / 2.f, drawLabelAnchor, labelRotationAngleDegrees);//原始的

//            Log.e("修改输出--->" , "label--->" + label + "---->" + angle);
//            /**
//             * 左边 90-270 右边 270-90
//             * */
            if (angle > 90 && angle < 270) {
                drawLabel(c, label, pOut.x - mXAxis.mLabelRotatedWidth / 2f, pOut.y - mXAxis.mLabelRotatedHeight / 2.f, drawLabelAnchor, labelRotationAngleDegrees);
            }
