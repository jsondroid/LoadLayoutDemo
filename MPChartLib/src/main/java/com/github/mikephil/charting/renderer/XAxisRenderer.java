...
public class XAxisRenderer extends AxisRenderer {
    ...
    public void renderAxisLabels(Canvas c) {
        ...
        } else if (mXAxis.getPosition() == XAxisPosition.CENTER) {//新修改的增加
            pointF.x = 0.5f;
            pointF.y = 0.0f;
            drawLabels(c, mViewPortHandler.getChartHeight()/2 + yoffset, pointF);
    ...
    public void renderAxisLine(Canvas c) {
        ...
        /**X轴显示在中间*/
        if (mXAxis.getPosition() == XAxisPosition.CENTER|| mXAxis.getPosition() == XAxisPosition.BOTTOM_INSIDE
                || mXAxis.getPosition() == XAxisPosition.BOTH_SIDED) {
            c.drawLine(mViewPortHandler.contentLeft(),
                    mViewPortHandler.getChartHeight()/2, mViewPortHandler.contentRight(),
                    mViewPortHandler.getChartHeight()/2, mAxisLinePaint);
        }
...
//                if(i!=0){
//                    int texth = Utils.calcTextHeight(mAxisLabelPaint, TextUtils.isEmpty(label)?"":label);
//                    c.drawLine(x,pos-texth,x,pos-texth/2,mAxisLinePaint);//新增加mXAxis.getYOffset()
//                }
                drawLabel(c, label, x, pos, anchor, labelRotationAngleDegrees);
            }
        }
//        int textw= Utils.calcTextWidth(mAxisLabelPaint,mXAxis.getDescription());
//        drawLabel(c, mXAxis.getDescription(), (mViewPortHandler.getChartWidth()-textw), pos, anchor, labelRotationAngleDegrees);
    }
