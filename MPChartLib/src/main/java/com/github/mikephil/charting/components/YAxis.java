...
public class YAxis extends AxisBase {
    ...
    /**
     * 修改过，这里是自己添加的,倾斜度mLabelRotationAngle左边倾斜则设置负数如-45度
    ...
    /**新加的*/
    private String leftYtopDes;

    public String getLeftYtopDes() {
        return leftYtopDes;
    }

    public void setLeftYtopDes(String leftYtopDes) {
        this.leftYtopDes = leftYtopDes;
    }
}
