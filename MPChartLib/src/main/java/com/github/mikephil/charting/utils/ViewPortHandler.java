...
//        mContentRect.set(offsetLeft, offsetTop, mChartWidth - offsetRight-Utils.convertDpToPixel(10f)/**新加的*/, mChartHeight - offsetBottom);//原始的
        mContentRect.set(offsetLeft, offsetTop, mChartWidth - offsetRight, mChartHeight - offsetBottom/**新修改的*/);
    }
