...
public class LoadingFrameLayout2 extends FrameLayout {
    ...
    public LoadingFrameLayout2(Context context) {
        this(context, null);
    }

    public LoadingFrameLayout2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoadingFrameLayout2(Context context, AttributeSet attrs, int defStyleAttr) {
